...
const components = {
  ...
  h2: ({ className, ...props }) => (
    <h2
      className={clsx(
        "mt-12 scroll-m-20 border-b-2 border-b-zinc-200 pb-1 text-3xl font-semibold tracking-tight first:mt-0",
        className,
      )}
      {...props}
    />
  ...
  img: ({
    ...
    <img
      className={clsx("my-0 rounded-xl border border-zinc-900/10", className)}
      alt={alt}
      {...props}
    />
  ),
